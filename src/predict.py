...
def predict(
    ...
    if modis.exists(): # if file exists, download the file locally
        ...
        download_modis(from_date=from_date, to_date=to_date, credentials=credentials, bucket=bucket_name)
    ...
    if era5.exists():
        ...
        download_era5(from_date=from_date, to_date=to_date, credentials=credentials, bucket=bucket_name)
